...
public class ProductCategoryParentListDirective extends BaseDirective
{
  ...
  {
    Long localLong = (Long)FreeMarkers.getParameter(PRODUCTCATEGORY_ID, Long.class, params);
    ProductCategory localProductCategory = (ProductCategory)this.productCategoryService.find(localLong);
    Object localObject;
    ...
    else
    {
      ...
      if (bool)
        localObject = this.productCategoryService.findParents(localProductCategory, localInteger, str);
      else
        localObject = this.productCategoryService.findParents(localProductCategory, localInteger);
    }
