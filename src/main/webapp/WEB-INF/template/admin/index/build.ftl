...
<title>${message("admin.index.build")} - Powered By HONGQIANG_SHOP</title>
...
<body>
	<div class="path">
		<a href="${base}${adminPath}/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.index.build")}
	</div>
