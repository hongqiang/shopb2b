...
<title>${message("admin.role.list")} - Powered By HONGQIANG_SHOP</title>
...
<body>
	<div class="path">
		<a href="${base}${adminPath}/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.role.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
