...
<title>${message("admin.deliveryCorp.add")} - Powered By HONGQIANG_SHOP</title>
...
<body>
	<div class="path">
		<a href="${base}${adminPath}/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.deliveryCorp.add")}
	</div>
