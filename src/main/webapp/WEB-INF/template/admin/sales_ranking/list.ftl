...
<title>${message("admin.salesRanking.list")} - Powered By HONGQIANG_SHOP</title>
...
<body>
	<div class="path">
		<a href="${base}${adminPath}/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.salesRanking.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
