...
<title>${message("admin.message.list")} - Powered By HONGQIANG_SHOP</title>
...
<body>
	<div class="path">
		<a href="${base}${adminPath}/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.message.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
			...
			[#list page.content as adminMessage]
				<tr>
					...
					<td>
						...
						[#else]
							<a href="${base}${adminPath}/member/view.jhtml?id=${adminMessage.receiver.id}">
