...
[@seo type = "index"]
	<title>[#if seo.title??][@seo.title?interpret /][#else]${message("shop.index.title")}[/#if][#if systemShowPowered] - Powered By HONGQIANG_SHOP[/#if]</title>
	...
	[/#if]
[/@seo]
<link rel="icon" href="${base}/resources/favicon.ico" type="image/x-icon" />
