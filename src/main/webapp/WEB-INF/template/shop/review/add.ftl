...
<title>${product.name} ${message("shop.review.title")}[#if systemShowPowered] - Powered By HONGQIANG_SHOP[/#if]</title>
				...
				success: function(message) {
					...
					if (message.type == "success") {
						setTimeout(function() {
							...
							location.href = "${base}${frontPath}/review/content/${product.id}.jhtml";
						}, 3000);
					} else {
						$submit.prop("disabled", false);
...
<body>
	...
	<div class="container review">
		...
		<div class="span18 last">
			...
			<form id="reviewForm" action="${base}${frontPath}/review/save.jhtml" method="post">
